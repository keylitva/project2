...
<body>
    ...
    <section class="home" id="home">
        <div class="content">
            <h1>Dragonfire</h1>
            <p>A fully swedish team with an oldschool swedish outlook on CS. There are no roles like lurker, entry or AWPer in the team, only an IGL. Every player is free to do as they please. The embodiment of "Fuck around, Find out."</p>
        ...
        <div class="image">
            <img src="images/Dragonfire_svensk_nb.png" alt="illustration-hero">
        </div>
    </section>
    ...
    <div class="row heading">
            ...
            <h1>Oskar ”hinkeN-” Skiöld Lundquist</h1>
            <p>Captain</p>
                <img src="images/Dragonfire_svensk_nb.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%">
            <p>A player with the very bad taste when it comes to skins. If something goes wrong you can always blame the one and only hinkeN-</p>
            </div>
            <div class="image scale">
            <h1>Linus "Odahh" Boman</h1>
            <p>Vice Captain</p>
                <img src="images/Dragonfire_svensk_nb.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%">
            <p>An experienced player with prior team experience in both Valorant and League of Legends.</p>
            </div>
        </div>   
    <div class="row heading">
            <!-- 1 Tab  -->
            <div class="image scale">
            <h1>Elliot "Säpos" Hedlund</h1>
            <p>Player</p>
                <img src="images/Dragonfire_svensk_nb.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%">
            <p>Taller than h1nken-</p>
            </div>
            <div class="image scale">
            <h1>Edwin ¨Ed3wW ツ¨ Strid</h1>
            <p>Player</p>
                <img src="images/Dragonfire_svensk_nb.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%">
            <p>A player with a lot of luck and small amount of skill</p>
            </div>
            <div class="image scale">
