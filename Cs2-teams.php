...
<body>
    ...
    <section class="home" id="home">
        <div class="content">
            <h1>Our Teams!</h1>
            <p>AngelSkar Teams that compete in CS2</p>
    ...
    <div class="row heading">
            ...
            <h1>Invicta</h1>
            <a href="cs2_Invicta.php"><img src="images/invicta_logo.png" alt="illustration-features-tab-1" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>
            <div class="image scale">
            <h1>Gunners</h1>
            <a href="cs2_Gunners.php"><img src="images/gunners_black.png" href="cs2_Gunners.php"alt="illustration-features-tab-2" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"> </a>
            </div>
        </div>
        <div class="row heading">
            <div class="image scale">
            <h1>Tempo</h1>
            <a href="cs2_Tempo.php"><img src="images/Tempo_Logo.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>
            <div class="image scale">
            <h1>Dragonfire</h1>
            <a href="cs2_Dragonfire.php"><img src="images/Dragonfire_svensk_nb.png" alt="illustration-features-tab-1" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>
        </div>
        <div class="row heading">
            <div class="image scale">
            <h1>Atomic</h1>
            <a href="cs2_Atomic.php"><img src="images/concept_atomic_logo_2023.png" alt="illustration-features-tab-1" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>

            <div class="image scale">
            <h1>Aegis</h1>
            <a href="cs2_Aegis.php"><img src="images/aegis_logo.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>
        ...
        <div class="row heading">
            ...
            <div class="image scale">
            <h1>Bravo</h1>
            <a href="cs2_Bravo.php"><img src="images/AN_black.png" alt="illustration-features-tab-2" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>
            <div class="image scale">
            <h1>Wataaa</h1>
            <a href="cs2_Wataa.php"><img src="images/AN_black.png" alt="illustration-features-tab-2" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%"></a>
            </div>
        </div>
