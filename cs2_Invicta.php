...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="image">
            <img src="images/invicta_logo.png" alt="illustration-hero">
        </div>
    </section>
    ...
    <div class="row heading">
            ...
            <p>Captain</p>
                <img src="images/invicta_logo.png" alt="illustration-features-tab-3" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" width="80%" height="80%">
            <p> hello</p>
            </div>
            <div class="image scale">
            <h1>Name IGN Surname</h1>
