...
<body>
    ...
    <section class="home" id="home">
        <div class="content">
            <h1>AngelSkar Legal</h1>
            <p>Angelskar's legal information!</p>
        </div>
    ...
    <section class="features" id="features">
        <div class="heading">
            <h1>Legal</h1>
            <p>Privacy Policy for angelskaresports
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to angelskaresports.
...
Website refers to angelskaresports, accessible from https://angelskaresports.com
...
By email: support@angelskaresports.com
Generated using Free Privacy Policy Generator</p>
</div>
        </div>
    </section>
